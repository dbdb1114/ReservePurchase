package com.reservation.stockservice.controller;

import com.reservation.stockservice.entity.AbstractStock;
import com.reservation.stockservice.entity.StockRedis;
import com.reservation.stockservice.redis.StockRedisRepository;
import com.reservation.stockservice.service.StockService;
...
//    @PutMapping("/stock/update/decrease")
//    public Mono<? extends AbstractStock> decreaseStock(@RequestBody List<RequestStock> requestStock) {
//        return Mono.just(stockService.decreaseStock(requestStock))
//                .log()
//                .doOnNext(sink::tryEmitNext);
//    }
//
//    @PutMapping("/stock/update/increase")
//    public Mono<? extends AbstractStock> increaseStock(@RequestBody List<RequestStock> requestStock) {
//        return Mono.just(stockService.increaseStock(requestStock))
//                .log()
//                .doOnNext(sink::tryEmitNext);
//    }
